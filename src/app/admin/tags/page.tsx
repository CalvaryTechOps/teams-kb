...
export default async function AdminTagsPage({
  ...
  return (
    <div>
      ...
      {error && (
        <p className="mt-4 rounded-lg border border-danger bg-danger-soft px-4 py-2.5 text-sm text-danger">
          {error}
        </p>
      )}
      {notice && (
        <p className="mt-4 rounded-lg border border-success bg-success-soft px-4 py-2.5 text-sm text-success">
          {notice}
        </p>
      )}
