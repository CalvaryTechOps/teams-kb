  ...
  return (
    <main className="grid min-h-screen grid-cols-1 lg:grid-cols-[minmax(380px,520px)_1fr]">
      <div className="hidden flex-col justify-between bg-sidebar p-12 lg:flex">
        ...
        <div>
          <h1 className="text-5xl font-black leading-[1.1] tracking-tight text-sidebar-fg">
            {APP_TITLE}
          </h1>
          <p className="mt-4 max-w-[340px] text-lg leading-relaxed text-sidebar-fg-muted">
            {settings["signin.tagline"]}
          </p>
        </div>
        <div className="text-xs text-sidebar-fg-subtle">{BUILT_BY}</div>
      </div>
      <div className="flex items-center justify-center bg-surface p-8 lg:p-12">
        <Suspense>
          <SignInCard
